...
export default function PokeBallColor() {
  return (
    <svg version="1.1" id="Pokéball" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 595.3 594.1" style={{width:"28px",cursor:"pointer"}} xmlSpace="preserve">
<g id="Pokéball_1_">
	<g id="Colours">
		<path id="Down" fill="#FFFFFF" d="M297.6,380.9c-40.4,0-74.1-28.6-82.1-66.6H81.1c9.5,110.5,102.2,197.2,215.1,197.2
		...
		<path id="Center" fill="#FFFFFF" d="M347.1,297L347.1,297C347,297,347,297,347.1,297c-0.1-6.1-1.2-11.9-3.2-17.3
		...
		<path id="Up" fill="#FF1C1C" d="M297.7,213.2c40.4,0,74.1,28.6,82.1,66.6h134.4C504.7,169.2,412,82.5,299,82.5S93.4,169.2,83.9,279.7
			h131.7C223.6,241.7,257.3,213.2,297.7,213.2z"/>
		<path id="Shadow_Up" fill="#DF1818" d="M458.3,279.7h55.8c-8.2-95.5-78.6-173.3-170.5-192.6C407.4,120.8,452.9,193.7,458.3,279.7z"/>
	</g>
